...
export class EditPenaltyPage {
  ...
  getHTML(data = {}) {
    return `
            <div class="container mt-4" style="max-width: 600px;">
                <h1>Изменение правила №${data.id || this.id}</h1>
  ...
  getData() {
    ajax.get(penaltiesUrls.getPenaltyById(this.id), (data) => {
      this.render(data);
    });
  }
  ...
  savePenalty() {
    ...
    ajax.patch(penaltiesUrls.updatePenaltyById(this.id), updatedData, () => {
